...
import snapfix from "./assets/sapfix";
...
function Home4() {
  return (
    <div className="py-10">
      ...
      <div style="background-image: url(snapfix);" className="border border-white bg-cover p-10  bg-center bg-no-repeat bg-blend-overlay bg-black/80 w-full h-full lg:hover:bg-[#05011f]/100 transition-all duration-500 text-white  hover:text-white rounded-2xl md:hover:bg-transparent hover:scale-80 ease-in-out ">
